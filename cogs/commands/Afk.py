...
class OnOrOff(BasicView):
    ...
    @discord.ui.button(label="Yes", emoji=" <a:tick_vaibhavs_lithium:1166037808868237364>", custom_id='Yes', style=discord.ButtonStyle.green)
    async def dare(self, interaction, button):
        self.value = 'Yes'
        self.stop()

    @discord.ui.button(label="No", emoji="<a:botcross_vaibhavs_lithium:1084877519871823972>", custom_id='No', style=discord.ButtonStyle.danger)
