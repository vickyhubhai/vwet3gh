      ...
      try:
                if antiSpam is True:
                  ...
                  if retry:
                      ...
                      if data["punishment"] == "kick":
                        ...
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Spam")
                        hacker = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Spam")
                        hacker1 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Spam")
                        hacker2 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Discord Invites")
                            hacker3 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Discord Invites")
                            hacker4 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             now = discord.utils.utcnow()
                             await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Discord Invites")
                             hacker5 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Link")
                          hacker6 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Link")
                          hacker7 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          now = discord.utils.utcnow()
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Titanium | Anti Link")
                          hacker8 = discord.Embed(color=0x2f3136,description=f"<a:tick_vaibhavs_lithium:1166037808868237364> | Successfully Muted {message.author} For Sending Links")
